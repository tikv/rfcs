...
If the key has RawKV prefix, then the value can be either:
...
// recover the deleted keyspace, if no name or id is provided, recover the lastest deleted keyspace
